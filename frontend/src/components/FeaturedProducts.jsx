    ...
    <div className='py-12'>
      <div className='container mx-auto px-4'>
        ...
        <div className='relative'>
          ...
          className={`absolute top-1/2 -right-4 transform -translate-y-1/2 p-2 rounded-full transition-color duration-300 ${isEndDisabled ? 'bg-gray-400 cursor-not-allowed' : 'bg-emerald-600 hover:bg-emerald-500' }`}
          >
